...
export default function PrivacyPolicy() {
    return (
        <main className="rich-text container">
            ...
            <ul>
                ...
                <li>
                    <p>
                        ...
                        <a
                            href="https://www.matt-winfield.com"
            ...
            <ul>
                <li>
                    ...
                    used to identify you. You may opt out of this analytics
                    tracking <Link to="/settings/analytics">here.</Link>
                </li>
                <li>
