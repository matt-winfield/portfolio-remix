    ...
    return (
        <main className="container relative min-h-screen">
            ...
            <motion.div
                ...
                initial="hidden"
                animate="visible"
                className="absolute bottom-0 left-1/2 right-0 z-10 flex w-full -translate-x-1/2 flex-wrap justify-center gap-x-6 gap-y-1 py-5 md:bottom-auto md:left-auto md:top-1/2 md:w-fit md:-translate-y-1/2 md:flex-col md:items-end md:gap-y-6 md:p-0"
            >
