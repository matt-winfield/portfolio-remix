...
export async function action({ request }: DataFunctionArgs) {
    ...
    const response = await sendEmail({
        ...
        subject: `Matt Winfield Portfolio Email Change Verification`,
...
export function EmailChangeEmail({
    ...
    return (
        <E.Html lang="en" dir="ltr">
            <E.Container>
                <h1>
                    <E.Text>Matt Winfield Portfolio Email Change</E.Text>
                </h1>
                <p>
                    <E.Text>
    ...
    return (
        <E.Html lang="en" dir="ltr">
            <E.Container>
                <h1>
                    <E.Text>
                        Your Matt Winfield Portfolio email has been changed
                    </E.Text>
                </h1>
                <p>
                    <E.Text>
                        We're writing to let you know that your Matt Winfield
                        Portfolio email has been changed.
                    </E.Text>
                </p>
                <p>
                    <E.Text>
                        If you changed your email address, then you can safely
                        ignore this. But if you did not change your email
